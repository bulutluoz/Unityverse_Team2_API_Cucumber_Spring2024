    ...
    Feature: US1002 kullanici JPH da post request ile test yapar
      ...
      Scenario: TC02 Post request

        Given Kullanici "jPHBaseUrl" base URL'ini kullanir
        Then Path parametreleri icin "posts" kullanir
        And POST request icin "Mehmet","Merhaba",10 bilgileri ile request body olusturur
        ...
        Then response attribute degerlerinin "Mehmet","Merhaba",10 ve 101 oldugunu test eder